...
local function oil_setup()
    require('oil').setup { -- Oil will take over directory buffers (e.g. `vim .` or `:e src/`)
...
-- Create the keymap that triggers the load
vim.keymap.set('n', '-', function()
    -- 1. Check if oil is loaded
    if not package.loaded['oil'] then oil_setup() end
    -- 2. Execute the oil command
    vim.cmd 'Oil'
